...
class DB:
    def __init__(self) -> None:
        try:
            ...
            self.cursor.execute('''CREATE TABLE IF NOT EXISTS watcher_order_table (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, shipment_number TEXT NULL, order_id INTEGER NULL, 
                                batches_text TEXT NOT NULL, is_done INTEGER NULL)''')
