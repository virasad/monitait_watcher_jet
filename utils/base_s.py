...
class DB:
    ...
    def shipment_write(self, shipment_number, destination, shipment_type, orders={}, unchanged_orders = {}, is_done=0, completed, counted, mismatch, not_detected, orders_quantity_specification={}):
        if True:
            cursor2 = self.dbconnect.cursor()
