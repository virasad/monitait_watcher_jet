...
class DB:
    def __init__(self) -> None:
        try:
            ...
            self.cursor.execute('''CREATE TABLE IF NOT EXISTS watcher_order_table (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, shipment_number TEXT NULL, orders TEXT NULL, is_done INTEGER NULL)''')
