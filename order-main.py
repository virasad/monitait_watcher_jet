...
## URLs
shipment_url = 'https://develop-app.monitait.com/api/elastic-search/batch/'
...
counter = Counter(arduino=arduino, db=db, camera=camera, scanner=scanner, shipment_url=shipment_url,
                  stationID_url= stationID_url, sendshipment_url=sendshipment_url, register_id=register_id, usb_serial_flag=usb_serial_flag)
