...
cp /home/pi/monitait_watcher_jet/init/monitait-watcher-jet.service /lib/systemd/system/
chmod 644 /lib/systemd/system/monitait-watcher-jet.service
chmod /home/pi/monitait_watcher_jet/main.py
