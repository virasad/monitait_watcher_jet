...
sqlite3 /home/pi/monitait_watcher_jet/monitait.db "create table monitait_table(id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, register_id TEXT, temp_a INTEGER, temp_b INTEGER, image_name TEXT, extra_info TEXT, ts TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL);"
